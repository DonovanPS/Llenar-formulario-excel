                ...
                for celdas_verificar, celda_firma in grupos_celdas_firma_rep:
                    if any(ws[celda].value for celda in celdas_verificar):
                        ...
                        if firma_key in imagenes_data:
                            ...
                            print(f"No se encontró firma específica para UID {uid_modificador}, usando firma por defecto en {dia}")

                        if firma_a_usar:
                            print(f"Insertando firma en {celda_firma} para el día {dia}")
